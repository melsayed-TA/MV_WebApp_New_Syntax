...
public class MVBuchungAnnonymUsingJSON extends TestBase{
		...
		public static Object[][] getTestData() throws JsonIOException, JsonSyntaxException, FileNotFoundException
		{
			...
			Object [][] jsonData = JSONFileDataReader.getdata(JSONPath, "MV_Testdaten", 2 , 2);   //1st 2 is the number of rows and 2nd 2 is the number of columns
			return jsonData;				
		}
		...
		public void durchfuehrenMVEinbuchung(String zulassungsland, String kennzeichen) throws IOException {
